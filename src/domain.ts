...
export type BookingType = 'PRE_POST'|'PARTY'|'OPEN_PLAY'
export type Booking = { id: string; type: BookingType; status: BookingStatus; scheduledAt: string; leagueId: string|null; leagueNameSnapshot: string|null; designation: 'PRE'|'POST'|null; teamDescription: string|null; partyName: string|null; partyAmountCents: number|null; customerName: string|null; expectedBowlers: number|null; lanesNeeded: number; notes: string|null; createdAt: string; createdBy: string; createdByName: string; updatedAt: string; updatedBy: string; updatedByName: string; version: number; startedAt: string|null; startedBy: string|null; startedByName: string|null; cancelledAt: string|null; cancelledBy: string|null; cancelledByName: string|null; cancellationNote: string|null; resultingSessionId: string|null }
